...
```jsx copy
import React from 'react';
import { Spinner, VKGroup } from "@vivakits/react-components";
...
```jsx copy
import React from 'react';
import { Button, Spinner, VKGroup } from "@vivakits/react-components";
  ...
  <tbody>
    <tr>
     ...
     <tr>
      <td>className</td>
      <td>CSS</td>
      <td>Additional CSS class(es) to apply to the spinner component</td>
      <td> - </td>
    </tr>
