...
import { dataTableColumnSample, rawDataTableData } from "../../libs/data";
...
```jsx copy
import React from 'react';
import { Button, Spinner } from "@vivakits/react-components";
...
<Tabs.Tab>
export const TableSpinnerBasic = () => {
...
```jsx copy
import React from 'react';
import { AsyncDatatable, Spinner } from "@vivakits/react-components";
...
Use spinners within select to offer visual cues during processing or ongoing actions.

<Tabs items={['Preview', 'Code']}>

<Tabs.Tab>

export const SelectSpinnerBasic = () => {
