...
<Tabs.Tab>
    ...
    <div className="flex items-start flex-wrap justify-start pb-8">
...
<Tabs items={['Preview', 'Code']}>
    <Tabs.Tab>
        <div className="flex items-center gap-8 flex-wrap justify-around py-8">
            <VKOtpInput />
...
<Tabs items={['Preview', 'Code']}>
    ...
    <Tabs.Tab>
        ...
        const App = ()=> {
          return(
            <VKOtpInput 
              renderSubmitButton={(value, callback) => 
                <Button rounded="md" size="md" variant="solid" className="!bg-primary !text-primary-foreground" onClick={() => callback(value)}>
                  Submit
                </Button>} />
          );
        };
...
<Tabs items={['Preview', 'Code']}>
    ...
    <Tabs.Tab>
        ...
        const App = ()=> {
          return(
            <VKOtpInput 
              renderResetButton={(callback) => 
                <Button rounded="md" size="md" variant="solid" className="!bg-primary !text-primary-foreground" onClick={() => callback()}>
                  Reset
                </Button>} />
          );
        };
...
<Tabs items={['Preview', 'Code']}>
    ...
    <Tabs.Tab>
        ...
        const App = ()=> {
          return <VKOtpInput inputLength={4} />
        };
...
<Tabs items={['Preview', 'Code']}>
    ...
    <Tabs.Tab>
        ...
        const App = ()=> {
          return <VKOtpInput required={true} />
        };
...
### Example
Below are the examples of OTP input component in used

<Tabs items={['Preview', 'Code']}>
<Tabs.Tab>
    <div className="flex items-center flex-wrap justify-around py-8">
    <VKOtpInput isMasked maskedIcon="🔒" />
    <VKOtpInput inputLength={4} groupSize={2} separator="-"/>
    <VKOtpInput className="border-0 border-b-2 border-b-gray-700 rounded-none" inputLength={4} groupSize={1} renderSubmitButton={(value, callback) => <Button rounded="md" size="md" variant="solid" className="!bg-primary !text-primary-foreground" onClick={() => callback(value)}>
          Submit
        </Button>}/>
    </div>
