...
export const DropdownTriggerComp = () => {
  return (
    <VKGroup border="none" color="none" noSeparator className="gap-3">
      <Dropdown>
        <DropdownTrigger action="click">
          <Button rounded="md" size="md" color="primary">Trigger on click</Button>
          </DropdownTrigger>
          <DropdownMenu>
      ...
      <Dropdown>
        <DropdownTrigger action="hover">
          <Button rounded="md" size="md" color="secondary">Trigger on hover</Button>
          </DropdownTrigger>
          <DropdownMenu>
          <DropdownItem value="Edit">Edit</DropdownItem>
          <DropdownItem value="Duplicate">Duplicate</DropdownItem>
