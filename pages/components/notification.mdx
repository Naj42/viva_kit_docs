...
export const NotificationsVariantGroup = () => {
    ...
    return (
        <>
            <VKNotifications />
            <VKGroup  color="none" border="none" noSeparator rounded="none" className="gap-3" childrenProps={{className:"rounded-md"}}>
                <Button
                    size="md"
                    rounded="lg"
                    onClick={() => {
...
<Tabs.Tab>
```jsx copy
import { VKNotifications, useVKNotifications, Button, VKGroup } from "@vivakits/react-components";
